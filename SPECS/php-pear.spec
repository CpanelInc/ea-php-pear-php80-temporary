...
pwd
echo "RUNTIME" %{scl_runtime} %{_bindir}
%{_bindir}/php --version
...
%changelog
* Fri Jul 24 2020 Julian Brown <julian.brown@cpanel.net> - 1.10.7-5
- ZC-7202: Manually update to the lastest PEAR, add php8.0 macro
